...
func fallbackCities(provinceID string) map[string]interface{} {
	citiesByProvince := map[string][]map[string]string{
		...
		"9": {
			...
			{"city_id": "55", "province_id": "9", "province": "Jawa Barat", "type": "Kabupaten", "city_name": "Bekasi", "postal_code": "17837"},
			...
			{"city_id": "108", "province_id": "9", "province": "Jawa Barat", "type": "Kabupaten", "city_name": "Cianjur", "postal_code": "43217"},
			{"city_id": "109", "province_id": "9", "province": "Jawa Barat", "type": "Kota", "city_name": "Cimahi", "postal_code": "40512"},
			...
			{"city_id": "211", "province_id": "9", "province": "Jawa Barat", "type": "Kabupaten", "city_name": "Majalengka", "postal_code": "45412"},
